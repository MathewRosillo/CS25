...
In main() you can see me demonstrate this by creating an instance of the class Product and then using the method printDetails to display its information


Display

The code will display that the constructor was called, The details of the instance of Product, and will also display that the desctructor was called
